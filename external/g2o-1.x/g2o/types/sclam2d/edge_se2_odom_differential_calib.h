#ifndef EDGE_SE2_ODOM_CALIB_DIFFERENTIAL_H
#define EDGE_SE2_ODOM_CALIB_DIFFERENTIAL_H
  ...
  class EdgeSE2OdomDifferentialCalib : public BaseMultiEdge<3, VelocityMeasurement>
  {
    public:
      ...
      void computeError()
      {
        ...
        VelocityMeasurement calibratedVelocityMeasurment = measurement();
        calibratedVelocityMeasurment.vl() *= params->estimate()(0);
        calibratedVelocityMeasurment.vr() *= params->estimate()(1);
