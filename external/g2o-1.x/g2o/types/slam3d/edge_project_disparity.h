#ifndef _EDGE_PROJECT_DISPARITY_H_
#define _EDGE_PROJECT_DISPARITY_H_
...
namespace g2o {
  ...
  class EdgeProjectDisparity : public BaseBinaryEdge<3, Vector3d, VertexSE3, VertexTrackXYZ> {
  public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW;
    EdgeProjectDisparity();
