...
#include "g2o/math_groups/se3_ops.h"
#include "types_sba.h"
...
class EdgeProjectXYZ2UV : public  BaseBinaryEdge<2, Vector2d, VertexPointXYZ, VertexSE3Expmap>
{
  public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    EdgeProjectXYZ2UV();
...
class EdgeProjectXYZ2UVQ : public  BaseBinaryEdge<3, Vector3d, VertexPointXYZ, VertexSE3Expmap>
{
  public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    EdgeProjectXYZ2UVQ();
...
// V: left v
// U: right u
class EdgeProjectXYZ2UVU : public  BaseBinaryEdge<3, Vector3d, VertexPointXYZ, VertexSE3Expmap>
{
  public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    EdgeProjectXYZ2UVU();
