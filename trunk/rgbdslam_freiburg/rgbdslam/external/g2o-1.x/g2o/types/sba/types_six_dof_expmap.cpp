...
namespace g2o {
  ...
  void G2O_ATTRIBUTE_CONSTRUCTOR init_six_dof_types(void)
  {
  ...
  BaseBinaryEdge<2, Vector2d, VertexPointXYZ, VertexSE3Expmap>()
  {
  }

  EdgeProjectXYZ2UVQ::EdgeProjectXYZ2UVQ() :
  BaseBinaryEdge<3, Vector3d, VertexPointXYZ, VertexSE3Expmap>()
  {
  }
